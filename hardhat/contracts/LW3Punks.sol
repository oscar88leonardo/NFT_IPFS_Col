...
contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 tokenId) public view virtual override returns (string memory) {
        ...
        /**
         * Here it checks if the length of the baseURI is greater than 0, if it is retun the baseURI and attach
         * the tokenId and '.json' to it so that it knows the location of the metadata json file for a given tokenID 
         * stored on IPFS
